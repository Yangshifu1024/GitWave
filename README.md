...
- **Diff viewer** — side-by-side and unified views, side-by-side image diffs (old / new versions rendered for png / jpg / gif / webp / bmp / ico / svg), Shiki syntax highlighting, per-hunk operations
...
- **Platform UX** — command palette, menu bar app mode, themes plus UI / monospace font family and size settings, one-click open of the active repo in the system file manager, a detected terminal, or a detected code editor (VS Code / Zed / VSCodium), Chinese / English interface with instant switching
