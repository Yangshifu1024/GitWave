...
- **Branches & sync** — create / switch / delete / rename, push / pull with confirm (pick the target remote), fetch across all remotes with stale tracking-ref pruning, sync status area, merge (ff & no-ff) with conflict panel
