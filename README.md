...
**Status:** v0.9.3 · [Release notes](https://github.com/Yangshifu1024/GitWave/releases) · [Product scope](./docs/pm/core/01-features.md) · [Engineering decisions](./docs/tech/README.md)
...
- **v0.9.0** — add several local repositories to a workspace at once: the Add dialog takes multiple folders, skips paths already in the workspace and repeats inside the batch, and reports unusable paths without aborting the batch
