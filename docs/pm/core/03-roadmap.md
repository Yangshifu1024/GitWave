...
> 当前发布版本：**v0.8.7**（三平台）。§2.1–§2.3 是已交付的规划基线，不是待办。
...
| **v0.4–v0.8** | 官网、自动更新、i18n、代理、凭证弹窗、图片 diff 等持续迭代 | 三平台 | **进行中**（当前 v0.8.7） |
...
| v0.8.x | 标题栏与操作栏合并、stash 按仓库隔离、未暂存图片 diff 读工作区、macOS dmg 公证票据、检出后侧栏揭示分支；当前 **v0.8.7** |
