...
> 当前发布版本：**v0.9.3**（三平台）。§2.1–§2.3 是已交付的规划基线，不是待办。
...
| **v0.4–v0.9** | 官网、自动更新、i18n、代理、凭证弹窗、图片 diff 等持续迭代 | 三平台 | **进行中**（当前 v0.9.3） |
...
| v0.9.x | 一次添加多个本地仓库、仓库标签栏滚轮横滚、stash 面板重做、提交列表滚动性能、时间格式统一 |
