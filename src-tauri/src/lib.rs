...
use application::{
    ...
    add_submodule, add_worktree, ai_palette_intent, amend_commit, apply_stash, checkout_branch,
    checkout_commit, checkout_remote_branch, cherry_pick_commit, clear_ai_api_key, clone_repo,
